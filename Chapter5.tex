...
\par
The main goal of this experiment is to obtain the relative calibration constants for every of the four FASTs' PMTs (pixels) with respect to the most iluminated pixel for three positions of ilumunation - from left, right and bottom. Full specifications of the pixels numbering and positions could be seen on fig. \ref{PMT orientation}.

\begin{figure}[H]
 \centering
 \includegraphics[scale=0.35, angle = 0]{./pictures/NumberingSky.png}
 \caption{Orientation of FASTs' PMTs (pixels), view from the sky.}
...
The results calculated by these equations for every position can be seen in following table.
