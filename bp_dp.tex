...
\par
I managed to close the thesis by analysis of FAST calibration data. It was shown that they differ from theoretical values, which can be caused by errors in experimental method itself or there are some undiscovered effects, that are neglected by the theoretical simulations.  
\par
